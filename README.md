...
### Control Commands (Keywords)
```
'start continuous mode' = starting continuous vision input
```
```
'stop continuous mode' = stopping continuous vision input
```
```
'exit vision companion' = shutting down vision companion
```
## License
